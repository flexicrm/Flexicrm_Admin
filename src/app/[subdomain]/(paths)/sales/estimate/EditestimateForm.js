                        ...
                        <Row>
                            <Col>
                                <div>
                                    ...
                                    <br />
                                    <Dropdown id="currency" name="currency" className="w-100 mb-3" options={currencies} onChange={(e) => formik.setFieldValue('currency', e.value)} value={formik.values.currency} placeholder="Select a Currency" />
