...
//             const response = await axiosInstance.get(`/user/${cookieSubdomain2}/${_id}`);
...
//                 mobile: usersList.mobile || '',
//                 email: usersList.email || '',
//                 userRole: usersList.userRole || '',
//                 salaryPerMonth: usersList.salaryPerMonth || '',
//                 address: {
//                     street: usersList.address?.street || '',
//                     city: usersList.address?.city || '',
//                     state: usersList.address?.state || '',
//                     zipCode: usersList.address?.zipCode || '',
//                     country: usersList.address?.country || ''
//                 }
//             });
//         }
//     }, [usersList]);
...
//         try {
//             const response = await axiosInstance.patch(`/user/${subdomain}/user/${_id}`, userData);
