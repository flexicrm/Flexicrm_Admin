...
const EditTaskForm = ({ onSubmit, users, projectsOptions, tagsOptions, task }) => {
    const taskData = task;
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            <Row>
                ...
                <InputText className="w-100 mb-3"
                    id="subject"
                    name="subject"
            ...
            <div>
                ...
                <Dropdown className="w-100 mb-3"
                    ...
                    onChange={(e) => formik.setFieldValue("repeatEvery", e.value)}
            ...
            <div>
                <label htmlFor="assignedTo">Assigned To</label><br />
                <MultiSelect className="w-100 mb-3"
                    id="assignedTo"
                    name="assignedTo"
                    options={users}
                    onChange={(e) => formik.setFieldValue("assignedTo", e.value)}
            ...
            <button type="submit" className="btn-all">Update</button>
        </form>
    );
};
