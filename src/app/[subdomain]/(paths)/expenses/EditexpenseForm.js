...
const EditExpenseForm = ({ onSubmit, expenses, customers, projectsOptions }) => {
    // console.log(expenses,"expesnse")
    const formik = useFormik({
        initialValues: {
            ...
            expenseBillUpload: expenses.expenseBillUpload,
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            <button type="button" className="btn-all" onClick={handleReset}>Reset</button>
        </form>
    );
};
