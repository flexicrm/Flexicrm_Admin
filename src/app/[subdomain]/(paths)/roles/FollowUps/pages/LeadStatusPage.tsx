...
const LeadFollowStatusPage: React.FC = () => {
                ...
                <Paper elevation={3} sx={{ borderRadius: 2, overflow: 'hidden' }}>
                    <TableContainer>
                        <Table size="small">
                            <TableHead>
                                <TableRow>
                                    <TableCell sx={{ fontWeight: 600 }}>Follow Status </TableCell>
...
export default LeadFollowStatusPage;
